...
/**
 * Classe utilitaire de gestion du chargement et de la sauvegarde des configuration.
 * 
 * @author S.Lucas
 */
...
{
  /**
   * Chargement des propriétés de configuration de l'application (depuis un éventuel fichier de configuration).
   */
  ...
  public static void updateProperty(String key, String value){
	  ...
	  PropertiesManager.writeProperties(prop, Constants.CONFIGURATION_FILE);
  }
}
